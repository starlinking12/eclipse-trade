    ...
    <div className="main">
      ...
      <div className="tgrid">
        ...
        <div className="glass obpanel">
          ...
          <div className="sell">
            <div className="obrow sell"><span className="obc">{(ethPrice + 5.8).toFixed(2)}</span><span className="obc">12.5</span><span className="obc">{(ethPrice + 5.8) * 12.5}</span></div>
            <div className="obrow sell"><span className="obc">{(ethPrice + 4.2).toFixed(2)}</span><span className="obc">8.3</span><span className="obc">{(ethPrice + 4.2) * 8.3}</span></div>
            <div className="obrow sell"><span className="obc">{(ethPrice + 3.5).toFixed(2)}</span><span className="obc">15.2</span><span className="obc">{(ethPrice + 3.5) * 15.2}</span></div>
          </div>
          <div className="obspr"><span className="obspr-p">${ethPrice.toFixed(2)}</span><span>Spread: 0.08%</span></div>
          <div className="buy">
            <div className="obrow buy"><span className="obc">{(ethPrice - 3.2).toFixed(2)}</span><span className="obc">22.1</span><span className="obc">{(ethPrice - 3.2) * 22.1}</span></div>
            <div className="obrow buy"><span className="obc">{(ethPrice - 4.8).toFixed(2)}</span><span className="obc">9.7</span><span className="obc">{(ethPrice - 4.8) * 9.7}</span></div>
            <div className="obrow buy"><span className="obc">{(ethPrice - 5.5).toFixed(2)}</span><span className="obc">14.3</span><span className="obc">{(ethPrice - 5.5) * 14.3}</span></div>
          </div>
        </div>
      </div>
